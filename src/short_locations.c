...
typedef struct {
    uint8_t numbers[SHORT_LOCATION_4_INDEX_ARRAY_SIZE];
    char stringInProgramMem[SHORT_LOCATION_4_STRING_LENGTH];
} SHORT_LOCATION_4;

const __attribute__((__progmem__)) SHORT_LOCATION_4 shortLocations_4[AMOUNT_SHORT_LOCATION_4_STRINGS] = {
...
typedef struct {
    uint8_t numbers[SHORT_LOCATION_5_INDEX_ARRAY_SIZE];
    char stringInProgramMem[SHORT_LOCATION_5_STRING_LENGTH];
} SHORT_LOCATION_5;

const __attribute__((__progmem__)) SHORT_LOCATION_5 shortLocations_5[AMOUNT_SHORT_LOCATION_5_STRINGS] = {
