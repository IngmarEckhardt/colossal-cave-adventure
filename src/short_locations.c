...
#include <stdlib.h>
#ifndef CCA_TEST
#define SHORT_LOCATION_DESCRIPTION_1_LENGTH 15
#define SHORT_LOCATION_DESCRIPTION_2_LENGTH 30
#define SHORT_LOCATION_DESCRIPTION_3_LENGTH 55
#define SHORT_LOCATION_DESCRIPTION_4_LENGTH 75
#define SHORT_LOCATION_DESCRIPTION_5_LENGTH 186
#else
