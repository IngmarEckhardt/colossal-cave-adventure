...
#define AMOUNT_OF_ACTION_DESCRIPTIONS_SMALL 116
...
typedef struct {
    uint8_t number[1];
    char description[ACTION_DESCRIPTIONS_MEDIUM_LENGTH];
} MediumAction;
const MediumAction mediumActions[AMOUNT_OF_ACTION_DESCRIPTIONS_MEDIUM] PROGMEM = {
...
typedef struct {
    uint8_t number[1];
    char description[ACTION_DESCRIPTIONS_LONG_LENGTH];
} LongAction;
const LongAction longActions[AMOUNT_OF_ACTION_DESCRIPTIONS_LONG] PROGMEM = {
