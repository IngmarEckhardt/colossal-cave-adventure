...
//{
//{{1,},{"Somewhere nearby is Colossal Cave, where others have found fortunes in \ntreasure and gold, though it is rumored
//that some who enter are never \nseen again.  Magic is said to work in the cave.  I will be your eyes \nand hands.  Dire
//        ct me with commands of 1 or 2 words.  I should warn \nyou that I look at only the first five letters of each word, so yo
//u'll \nhave to enter \"Northeast\" as \"ne\" to distinguish it from \"North\".  \n(Should you get stuck, type \"help\" f
//or some general hints).\n\n"},
//{{2,},{"A little dwarf with a big knife blocks your way.\n"},
//{{3,},{"A little dwarf just walked around a corner, saw you,\nthrew a little axe at you which missed, cursed, and ran aw
//ay.\n"},
...
//To move, try words \nlike forest, building, downstream, enter, east, west, north, south, up \nor down.  \nI know about
//        a few special objects, like a black rod hidden in the \ncave.  These objects can be manipulated using some of the actio
//n words \nI know. Usually you will need to give both the object and action words \n(In either order), but sometimes I ca
//n infer the object from the verb \nalone.  Some objects also imply verbs; in particular, \"inventory\" \nimplies \"take
//inventory\", which causes me to give you a list of what \nyou're carrying.\nThe objects have side effects; for instance,
//the rod scares the bird. \nUsually people having trouble moving just need to try a few more \nwords.  Usually people tr
//        ying unsuccessfully to manipulate an object \nare attempting something beyond their (or my!) capabilities and should \nt
//        ry a completely different tack.\nTo speed the game up, you can sometimes move long distances with a \nsingle word.  For
//        example, \"building\" usually gets you to the building \nfrom anywhere above ground except when lost in the forest.  Als
//o, note \nthat cave passages turn a lot, and that leaving a room to the north \ndoes not guarantee entering the next fro
//        m the south. Good luck!\n"},
//{{52,},{"It misses!\n"},
//{{53,},{"It gets you!\n"},
//{{54,},{"OK\n"},
//{{55,},{"You can't unlock the keys.\n"},
//{{56,},{"You have crawled around in some little holes and wound up\nback in the main passage.\n"},
//{{57,},{"I don't know where the cave is, but hereabouts no stream\ncan run on the surface for very long.  I would try th
//e stream.\n"},
//{{58,},{"I need more detailed instructions to do that.\n"},
//{{59,},{"I can only tell you what you see as you move about and\nmanipulate things.  I cannot tell you where remote thin
//gs are.\n"},
//{{60,},{"I don't know that word.\n"},
//{{61,},{"What?\n"},
//{{62,},{"Are you trying to get into the cave?\n"},
//{{63,},{"The grate is very solid and has a hardened steel lock.  You\ncannot enter without a key, and there are no keys
//nearby.\nI would recommend looking elsewhere for the keys.\n"},
//{{64,},{"The trees of the forest are large hardwood oak and maple,\nwith an occasional grove of pine or spruce.  There i
//s quite\na bit of undergrowth, largely birch and ash saplings plus\nnondescript bushes of various sorts.  This time of y
//ear \nvisibility is quite restricted by all the leaves, but travel\nis quite easy if you detour around the spruce and be
//        rry\nbushes.\n"},
//{{65,},{"\n                              Welcome to \n\n                       Colossal Cave Adventure!\n\n\n
//Original development by Willie Crowther.\n                  Major features added by Don Woods.\n                 Con
//version to BDS C by J. R. Jaeger.\n                Unix standardization by Jerry D. Pohl.\n            Port to QNX 4 and
//        bug fixes by James Lummel.\n\nWould you like instructions?\n\n"},
//{{66,},{"Digging without a shovel is quite impractical.  Even with a\nshovel progress is unlikely.\n"},
//{{67,},{"Blasting requires dynamite.\n"},
//{{68,},{"I'm as confused as you are.\n"},
//{{69,},{"Mist is a white vapor, usually water.  Seen from time to time\nin caverns.  It can be found anywhere but is fre
//quently a\nsign of a deep pit leading down to water.\n"},
//{{70,},{"Your feet are now wet.\n"},
//{{71,},{"I think I just lost my appetite.\n"},
//{{72,},{"Thank you.  It was delicious!\n"},
//{{73,},{"You have taken a drink from the stream.  The water tastes\nstrongly of minerals, but is not unpleasant.  It is
//extremely\ncold.\n"},
...
//{{142,},{"If you want to end your adventure early, say \"quit\".  To suspend your \nadventure such that you can continue
//later say \"suspend\" (or \"pause\" \nor \"save\").  To load a previously saved game, say 'load' or 'restore'.  \nTo se
//e how well you're doing, say \"score\".  To get full credit for a \ntreasure, you must have left it safely in the buildi
//ng, though you get \npartial credit just for locating it. You lose points for getting \nkilled, or for quitting, though
//        the former costs you more. \nThere are also points based on how much (If any) of the cave you've \nmanaged to explore;
//in particular, there is a large bonus just for \ngetting in (to distinguish the beginners from the rest of the pack), \n
//        and there are other ways to determine whether you've been through some \nof the more harrowing sections. \nIf you think
//you've found all the treasures, just keep exploring for a \nwhile.  If nothing interesting happens, you haven't found th
//        em all \nyet.  If something interesting DOES happen, it means you're getting a \nbonus and have an opportunity to garner
//many more points in the \nmaster's section.\nI may occasionally offer hints in you seem to be having trouble.  If I \nd
//o, I'll warn you in advance how much it will affect your score to \naccept the hints.  Finally, to save paper, you may s
//pecify \"brief\", \nwhich tells me never to repeat the full description of a place unless \nyou explicitly ask me to.\n"
//},
...
//{{162,},{"Just as you reach the other side, the bridge buckles beneath\nthe weight of the bear, which was still followin
//g you around.\nYou scrabble desperately for support, but as the bridge \ncollapses you stumble back and fall into the ch
//asm.\n"},
//{{163,},{"The bear lumbers toward the troll, who lets out a\nstartled shriek and scurries away.  The bear soon gives\nup
//pursuit and wanders back.\n"},
